...
export const Cart = () => {
  const st0 = { fill:'none',stroke: '#fff',strokeWidth: 3.2003, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 10 }
  const st1 = { fill:'none',stroke: '#fff',strokeWidth: 1.6001, strokeLinejoin: 'round', strokeMiterlimit: 10 }
  const st2 = { fill:'none',stroke: '#fff',strokeWidth: 2.8503, strokeLinejoin: 'round', strokeMiterlimit: 10 }
  return(
